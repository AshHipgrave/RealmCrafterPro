...
{
    public partial class cTrackBar : cControl
    {
        public cTrackBar(string Name, string toSaveName, string toSaveParent)
        {
            control = GE.GUIManager.CreateTrackBar(Name, new NVector2(0, 0), new NVector2(0, 0));
            control.Tag = this;
        ...
        {
            NTrackBar trackbar = (NTrackBar)control;
            base.LoadControl(X);
        }
