...
{
    public partial class cComboBox : cControl
    {
        public cComboBox(string Name, string toSaveName, string toSaveParent)
        {
            control = GE.GUIManager.CreateComboBox(Name, new NVector2(0, 0), new NVector2(0, 0));
            control.Tag = this;
        ...
        {
            NComboBox combobox = (NComboBox)control;
            base.LoadControl(X);
