...
{
    public partial class cScrollBar : cControl
    {
        public cScrollBar(string Name, string toSaveName, string toSaveParent)
        {
            control = GE.GUIManager.CreateScrollBar(Name, new NVector2(0, 0), new NVector2(0, 0), true);
            control.Tag = this;
        ...
        {
            NScrollBar image = (NScrollBar)control;
            base.LoadControl(X);
        }
