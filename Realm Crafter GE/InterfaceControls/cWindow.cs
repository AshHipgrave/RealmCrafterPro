...
{
    public partial class cWindow : cControl
    {
        public cWindow(string Name, string toSaveName, string toSaveParent)
        {
            control = GE.GUIManager.CreateWindow(Name, new NVector2(0, 0), new NVector2(0, 0));
            control.Tag = this;
        ...
        {
            NWindow window = (NWindow)control;
            base.LoadControl(X);
        }
