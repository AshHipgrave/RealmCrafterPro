...
{
    public partial class cTextBox : cControl
    {
        public cTextBox(string Name, string toSaveName, string toSaveParent)
        {
            control = GE.GUIManager.CreateTextBox(Name, new NVector2(0, 0), new NVector2(0, 0));
            control.Tag = this;
        ...
        {
            NTextBox textbox = (NTextBox)control;
            base.LoadControl(X);
        }
