...
{
    public partial class cProgressBar : cControl
    {
        public cProgressBar(string Name, string toSaveName, string toSaveParent)
        {
            control = GE.GUIManager.CreateProgressBar(Name, new NVector2(0, 0), new NVector2(0, 0));
            control.Tag = this;
        ...
        {
            NProgressBar progressBar = (NProgressBar)control;
            base.LoadControl(X);
        }
