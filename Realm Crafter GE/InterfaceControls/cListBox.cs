...
{
    public partial class cListBox : cControl
    {
        public cListBox(string Name, string toSaveName, string toSaveParent)
        {
            control = GE.GUIManager.CreateListBox(Name, new NVector2(0, 0), new NVector2(0, 0));
            control.Tag = this;
        ...
        {
            NListBox window = (NListBox)control;
            base.LoadControl(X);
        }
