...
namespace RealmCrafter_GE.Property_Interfaces
{
    public class LightPropertyInterface
    {
        ...
        [Category("Color"), Editor(typeof(RenderingServices.Vector3ColorEditor), typeof(System.Drawing.Design.UITypeEditor)), TypeConverter(typeof(RenderingServices.Vector3ColorOptionsConverter))]
        public RenderingServices.Vector3 Color
        {
            get
            {
                return new RenderingServices.Vector3(
                    Convert.ToSingle(_Object.Red) / 255.0f,
                    Convert.ToSingle(_Object.Green) / 255.0f,
                    Convert.ToSingle(_Object.Blue) / 255.0f);
            }

            set
            {
                _Object.Red = Convert.ToByte(value.X * 255.0f);
                _Object.Green = Convert.ToByte(value.Y * 255.0f);
                _Object.Blue = Convert.ToByte(value.Z * 255.0f);
...
//         }
        ...
        [CategoryAttribute("Misc"), Editor(typeof(RealmCrafter.LightFunctionListEditor), typeof(System.Drawing.Design.UITypeEditor))]
