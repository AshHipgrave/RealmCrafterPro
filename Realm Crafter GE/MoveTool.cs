...
namespace RealmCrafter_GE
{
    public class MoveTool : TransformTool
    {
        ...
        public MoveTool(Entity parent)
        {
            BuildMesh();
            Parent = parent;
        }

        public MoveTool(Entity parent, EventHandler objectMoving, EventHandler objectMoved)
        {
            Parent = parent;
        ...
        public override void Update(int x, int y)
        {
            ...
            Vector3 Pos = null;
            if(Parent != null)
                Pos = new Vector3(Parent.X(), Parent.Y(), Parent.Z());
            else
                Pos = new Vector3();
...
//                     Pos.Z = RenderWrapper.bbdx2_ProjectedZ() - Offset.Z;
            ...
            if (Parent != null)
                Parent.Position(Pos.X, Pos.Y, Pos.Z);
