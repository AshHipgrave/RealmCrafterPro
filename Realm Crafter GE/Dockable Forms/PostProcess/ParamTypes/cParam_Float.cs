...
{
    public delegate void OnParamChangeCallback( string value, string paramName );
    class cParam_Float
    {
        ...
        public cParam_Float( System.Windows.Forms.Control Parent,
...
//             tableLayoutPanel4.SuspendLayout();
            ...
            textB.Text = value;
            tb.Value = (int)(System.Convert.ToDouble(value) * tb.Maximum);
...
//             tableLayoutPanel4.ResumeLayout(false);
        ...
        {
            textB.Text = ((float)tb.Value / (float)tb.Maximum).ToString();
            ParamChangeCallback(textB.Text, gb.Text);
        }
    }
}
