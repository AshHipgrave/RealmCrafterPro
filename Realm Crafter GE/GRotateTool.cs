...
{
    public class GRotateTool : TransformTool
    {
        ...
        public GRotateTool(Entity parent)
        {
            BuildMesh();
            Parent = parent;
        }

        public GRotateTool(Entity parent, EventHandler objectRotating, EventHandler objectRotated)
        {
            Parent = parent;
            if (Parent != null)
