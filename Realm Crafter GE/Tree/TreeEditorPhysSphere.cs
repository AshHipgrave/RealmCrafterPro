...
{
    public class TreeEditorPhysSphere : TreeEditorPhysObj
    {
        Entity Mesh;

        public TreeEditorPhysSphere()
        {
            Mesh = Program.TreeSphere.Copy();
            Mesh.Visible = true;
        ...
        public override void UpdateWorldButtonSelection()
        {
            ...
            if (Program.GE.SetWorldButtonSelection == (int)GE.WorldButtonSelection.SCALE)
            {
                ...
                (Program.Transformer as ScaleTool).AllowScaleY = false;
                (Program.Transformer as ScaleTool).CopyXToY = true;
            }
        }
        ...
        {
            x.WriteStartElement("physsphere");
