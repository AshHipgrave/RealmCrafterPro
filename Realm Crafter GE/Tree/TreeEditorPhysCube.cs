...
{
    public class TreeEditorPhysCube : TreeEditorPhysObj
    {
        Entity Mesh;

        public TreeEditorPhysCube()
        {
            Mesh = Program.TreeCube.Copy();
            Mesh.Visible = true;
