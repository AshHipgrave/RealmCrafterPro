	...
	namespace GUI
	{
		...
		*/
		...
		public:
			...
			IListBox(NGin::Math::Vector2& ScreenScale, IGUIManager* Manager) : IControl(ScreenScale, Manager) {}
			virtual ~IListBox() {}
			...
			*/
			...
			__declspec(property(get=zzGet_SelectionForeColor, put=zzPut_SelectionForeColor)) NGin::Math::Color SelectionForeColor;
			virtual void zzPut_SelectionForeColor(NGin::Math::Color Value) = 0;
			virtual NGin::Math::Color zzGet_SelectionForeColor() = 0;

			//! Background color of the selected item
			__declspec(property(get=zzGet_SelectionBackColor, put=zzPut_SelectionBackColor)) NGin::Math::Color SelectionBackColor;
			virtual void zzPut_SelectionBackColor(NGin::Math::Color Value) = 0;
			virtual NGin::Math::Color zzGet_SelectionBackColor() = 0;
