...
{
	class CPlayerHelp : public IPlayerHelp
	{
		...
		void ScrollBar_Scroll(NGin::GUI::IControl* control, NGin::GUI::ScrollEventArgs* e);

	public:

		CPlayerHelp(NGin::GUI::IGUIManager* guiManager);
		virtual ~CPlayerHelp();
