...
namespace RealmCrafter
{
	namespace SDK
	{
		class CProgressBarHost : public IControlHost
		{
			NGin::GUI::IProgressBar* Handle;

		public:

			CProgressBarHost(IControlHostManager* manager, IControlHost* master);
			virtual ~CProgressBarHost();
