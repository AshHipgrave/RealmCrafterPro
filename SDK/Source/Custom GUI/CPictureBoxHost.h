...
namespace RealmCrafter
{
	namespace SDK
	{
		class CPictureBoxHost : public IControlHost
		{
			NGin::GUI::IPictureBox* Handle;

		public:

			CPictureBoxHost(IControlHostManager* manager, IControlHost* master);
			virtual ~CPictureBoxHost();
