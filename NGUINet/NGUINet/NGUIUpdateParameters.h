...
namespace NGUINet
{
	...
	public ref class NGUIUpdateParameters
	{
	public:

		NGUIUpdateParameters();
		
		NGUINet::NVector2^ MousePosition;
		bool LeftDown;
		bool RightDown;
		...
		//! Find the topmost hovered control
		NGUINet::NControl^ MouseThumb;

		//! Pointer to a list of input characters
		System::Collections::Generic::List<int>^ InputBuffer;
	};
}
