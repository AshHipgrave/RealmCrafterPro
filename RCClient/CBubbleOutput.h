...
namespace RealmCrafter
{
	...
	class CBubbleOutput : public NGin::GUI::IControl
	{
	protected:

		NGin::GUI::IGUIManager* Manager;
		NGin::GUI::IGUIMeshBuffer* MeshBuffer;
		NGin::GUI::ILabel* Caption;
	...
	public:
		...
		CBubbleOutput(NGin::Math::Vector2& screenScale, NGin::GUI::IGUIManager* manager);
		virtual ~CBubbleOutput();
		bool Initialize();
