...
namespace RealmCrafter
{
	...
	class CControlEditor2 : public RealmCrafter::IControlEditor
	{
	protected:
	...
	public:
		...
		CControlEditor2(NGin::Math::Vector2& ScreenScale, NGin::GUI::IGUIManager* Manager);
		virtual ~CControlEditor2();
		...
		static CControlEditor2* Create(NGin::GUI::IGUIManager* manager, std::string name, NGin::Math::Vector2 &location, NGin::Math::Vector2 &size);
