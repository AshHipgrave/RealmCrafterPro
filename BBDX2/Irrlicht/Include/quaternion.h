...
{
	quaternion tmp;
	D3DXQuaternionMultiply((D3DXQUATERNION*)&tmp, (D3DXQUATERNION*)this, (D3DXQUATERNION*)&other);
	return tmp;
}
...
inline quaternion& quaternion::operator*=(const quaternion& other)
{
	D3DXQuaternionMultiply((D3DXQUATERNION*)this, (D3DXQUATERNION*)this, (D3DXQUATERNION*)&other);
	return *this;
}
...
{
	D3DXQuaternionRotationYawPitchRoll((D3DXQUATERNION*)this, y * DEGTORAD, x * DEGTORAD, z * DEGTORAD);
}
...
{
	D3DXQuaternionSlerp((D3DXQUATERNION*)this, (D3DXQUATERNION*)&q1, (D3DXQUATERNION*)&q2, time);
	return *this;
}
...
{
	return D3DXQuaternionDot((D3DXQUATERNION*)this, (D3DXQUATERNION*)&q2);
}
