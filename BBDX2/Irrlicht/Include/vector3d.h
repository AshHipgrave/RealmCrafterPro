...
namespace core
{
	...
	public:
		...
		f64 getLength() const { return D3DXVec3Length((D3DXVECTOR3*)this); }

		//! Returns squared length of the vector.
		/** This is useful because it is much faster then
		getLength(). */
		T getLengthSQ() const { return D3DXVec3LengthSq((D3DXVECTOR3*)this); }
		...
		{
			D3DXVECTOR3 DistVec;
			D3DXVec3Subtract(&DistVec, (D3DXVECTOR3*)this, (D3DXVECTOR3*)&other);
			return D3DXVec3LengthSq(&DistVec);
		}
		...
		{
			vector3d<T> Out;
			D3DXVec3Cross((D3DXVECTOR3*)&Out, (D3DXVECTOR3*)this, (D3DXVECTOR3*)&p);
			return Out;
		}
