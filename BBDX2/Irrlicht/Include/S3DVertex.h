...
struct S3DVertexTangents
{
	...
	S3DVertexTangents(const core::vector3df& pos,
		const core::vector2df& tcoords, const core::vector2df& tcoords2,	const SColor& c)
		: Pos(pos), Color(c), TCoords(tcoords), TCoords2(tcoords2) { }

	S3DVertexTangents(const core::vector3df& pos,
		const core::vector2df& tcoords, const core::vector2df& tcoords2,	const SColor& c, const core::vector3df& normal)
		: Pos(pos), Color(c), TCoords(tcoords), Normal(normal), TCoords2(tcoords2) { }
