...
//void CDummyTransformationSceneNode::OnPostRender(u32 timeMs)
void CDummyTransformationSceneNode::OnPreRender()
{
	if(IsVisible)
	{
	...
	//if(strcmp(this->getName(), "Head") == 0)
	//{
	//	char OO[1024];
	//	this->updateAbsolutePosition();
	//	sprintf(OO, "%x: %f, %f, %f\n", this, this->getAbsolutePosition().X, this->getAbsolutePosition().Y, this->getAbsolutePosition().Z);
