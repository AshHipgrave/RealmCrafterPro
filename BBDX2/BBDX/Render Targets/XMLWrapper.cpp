...
String XMLReader::GetAttributeName(int Index)
{
	return ((IrrXMLReader*)Reader)->getAttributeName(Index);
}

int XMLReader::GetAttributeInt(String Name)
{
	return ((IrrXMLReader*)Reader)->getAttributeValueAsInt(Name.c_str());
}

float XMLReader::GetAttributeFloat(String Name)
{
	return ((IrrXMLReader*)Reader)->getAttributeValueAsFloat(Name.c_str());
}

String XMLReader::GetAttributeString(String Name)
{
	return ((IrrXMLReader*)Reader)->getAttributeValue(Name.c_str());
}