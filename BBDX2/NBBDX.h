...
#define DLLIN extern "C" _declspec(dllexport)
...
DLLIN void* bbdx2_GetIDirect3DDevice9();
...
DLLIN void bbdx2_ProjectVector3(void* Point, void* Out);
DLLIN void bbdx2_UnProjectVector3(void* Point, void* Out);
