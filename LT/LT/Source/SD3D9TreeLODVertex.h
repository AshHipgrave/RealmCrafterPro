...
namespace LT
{
	...
	struct SD3D9TreeLODVertex
	{
		...
		//! Billboard Scales
		D3DXFLOAT16 BillScaleX, BillScaleY;
		...
		inline void SetBillboardScale(float x, float y)
		{
			D3DXFloat32To16Array(&BillScaleX, &x, 1);
			D3DXFloat32To16Array(&BillScaleY, &y, 1);
		}
	};
}
