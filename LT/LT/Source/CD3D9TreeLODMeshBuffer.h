...
namespace LT
{
	...
	class CD3D9TreeLODMeshBuffer : public ITreeMeshBuffer
	{
	protected:
	...
	public:
		...
		CD3D9TreeLODMeshBuffer(IDirect3DDevice9* device);
		virtual ~CD3D9TreeLODMeshBuffer();

		virtual bool Set() const;
		virtual bool Draw(unsigned int &trianglesDrawn) const;
		virtual unsigned int GetTriangleCount() const;
		
		static CD3D9TreeLODMeshBuffer* CreateD3D9TreeLODMeshBuffer(
			IDirect3DDevice9* device,
