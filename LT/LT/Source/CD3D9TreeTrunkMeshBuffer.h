...
namespace LT
{
	...
	class CD3D9TreeTrunkMeshBuffer : public ITreeMeshBuffer
	{
	protected:
	...
	public:
		...
		CD3D9TreeTrunkMeshBuffer(IDirect3DDevice9* device);
		virtual ~CD3D9TreeTrunkMeshBuffer();

		virtual bool Set() const;
		virtual bool Draw(unsigned int &trianglesDrawn) const;
		virtual unsigned int GetTriangleCount() const;
		
		static CD3D9TreeTrunkMeshBuffer* CreateD3D9TreeTrunkMeshBuffer(
			IDirect3DDevice9* device,
